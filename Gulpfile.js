...
gulp.task('css-default', function () {
    return gulp.src('public/assets/css/pages/*.css')
        ...
        .pipe(concat('photoevent.min.css'))
...
gulp.task('javascript-service', function(cb) {
    pump([
        ...
        concat('service.photoevent.min.js'),
...
gulp.task('watch-default', function(){
    ...
    gulp.watch([ 'public/assets/js/pages/*js/*.js' ], { ignoreInitial: false }, function() {
        gulp.start('javascript-pages');
    });
